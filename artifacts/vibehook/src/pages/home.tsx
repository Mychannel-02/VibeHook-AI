...
import { useGenerateHooks, GenerateHooksParams } from "@/hooks/use-gemini";
...
export default function Home() {
  ...
  const handleGenerate = (params: GenerateHooksParams) => {
    ...
    setHooks([]); // Clear old results to show loading smoothly
  ...
  return (
    <div className="min-h-screen flex flex-col relative selection:bg-primary/30">
      ...
      <main className="flex-grow flex flex-col items-center w-full">
        ...
        {!hooks.length && !generateMutation.isPending && (
          <HowItWorks />
        )}
      </main>
